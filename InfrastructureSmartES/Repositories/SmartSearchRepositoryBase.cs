...
namespace InfrastructureSmartES.Repositories
{
    public abstract class SmartSearchRepositoryBase<TDocument, TPrimaryKey>
         : ISmartSearchRepository<TDocument, TPrimaryKey>
         ...
         where TPrimaryKey : struct
    {
        ...
        protected SmartSearchRepositoryBase(IElasticContextProvider context, string indexName)
        {
            _context = context;
            IndexName = indexName;
        }
